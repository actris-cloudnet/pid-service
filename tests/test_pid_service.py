...
class TestPidService:
    ...
    def test_generate_pid_for_collection(self, session_adapter):
        session, adapter = session_adapter
        adapter.register_uri('PUT', 'mock://test/api/handles/21.T12995/2.ce8154c1a6aa4f44',
                             additional_matcher=validate_request('mock://test2/collection/ce8154c1a6aa4f44b953780b016987b5'),
                             json=handle_response)
